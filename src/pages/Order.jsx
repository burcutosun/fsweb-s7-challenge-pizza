        ...
        <>  
            ...
            <Row className="order-info-section g-0">                
                <Container className="order-info" fluid>
                    <img className="form-banner" src=".\assets\mile2-aseets\pictures\form-banner.png"/>
                    ...
                    <Row className=" g-0" style={{margin:'2rem 0'}}>
                        ...
                        <Col className="gray-text" style={{ textAlign:'right'}}>4.9</Col>
                        <Col className="gray-text" style={{textAlign:'right'}}>(200)</Col> 
                    </Row>
